...
description_list = {
    ...
    'tempest_report.tempest_addons:NeutronExtensionTest.test_security_group': {'service': 'Network (Neutron)', 'feature': 'security-group', }, 
    'tempest_report.tempest_addons:NeutronExtensionTest.test_l3_agent_scheduler': {'service': 'Network (Neutron)', 'feature': 'L3 Agent Scheduler', }, 
    'tempest_report.tempest_addons:NeutronExtensionTest.test_ext_gw_mode': {'service': 'Network (Neutron)', 'feature': 'Neutron L3 Configurable external gateway mode', }, 
    'tempest_report.tempest_addons:NeutronExtensionTest.test_binding': {'service': 'Network (Neutron)', 'feature': 'Port Binding', }, 
    'tempest_report.tempest_addons:NeutronExtensionTest.test_quotas': {'service': 'Network (Neutron)', 'feature': 'Quota management support', }, 
    'tempest_report.tempest_addons:NeutronExtensionTest.test_agent': {'service': 'Network (Neutron)', 'feature': 'agent', }, 
    'tempest_report.tempest_addons:NeutronExtensionTest.test_dhcp_agent_scheduler': {'service': 'Network (Neutron)', 'feature': 'DHCP Agent Scheduler', }, 
    'tempest_report.tempest_addons:NeutronExtensionTest.test_multi_provider': {'service': 'Network (Neutron)', 'feature': 'Multi Provider Network', }, 
    'tempest_report.tempest_addons:NeutronExtensionTest.test_external_net': {'service': 'Network (Neutron)', 'feature': 'Neutron external network', }, 
    'tempest_report.tempest_addons:NeutronExtensionTest.test_router': {'service': 'Network (Neutron)', 'feature': 'Neutron L3 Router', }, 
    'tempest_report.tempest_addons:NeutronExtensionTest.test_allowed_address_pairs': {'service': 'Network (Neutron)', 'feature': 'Allowed Address Pairs', }, 
    'tempest_report.tempest_addons:NeutronExtensionTest.test_extra_dhcp_opt': {'service': 'Network (Neutron)', 'feature': 'Neutron Extra DHCP opts', }, 
    'tempest_report.tempest_addons:NeutronExtensionTest.test_provider': {'service': 'Network (Neutron)', 'feature': 'Provider Network', }, 
    'tempest_report.tempest_addons:NeutronExtensionTest.test_extraroute': {'service': 'Network (Neutron)', 'feature': 'Neutron Extra Route', },
